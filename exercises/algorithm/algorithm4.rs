    ...
    T: Ord,
{
    ...
    // Insert a value into the tree rooted at this node
    fn insert(&mut self, value: T) {
        match value.cmp(&self.value) {
            ...
            Ordering::Equal => {
                // Duplicate value insertion (handled as needed)
                // For simplicity, we won't insert duplicate values in this example
